...
public class UrlValidator implements Serializable {
    ...
    public boolean isValid(String value) {
        ...
        //checks to see that there is a URL input, if not return&&;
        ...
        //urls appear to be in a certain format&&
        //<scheme> :// <host> <path>
        //https://developer.mozilla.org/en-US/Add-ons/WebExtensions/Match_patterns

        //so checking to see if the url pattern matches this basic template
        ...
        //next testing the first part of the match pattern, the scheme
        //at each point, checks part of the match pattern. and if false, then 
        //returns false. sequential testing
        ...
        if ("file".equals(scheme)) {// Special case - file: allows an empty authority
            ...
            //file is the scheme that allows host/authority to be optional
            //host and portnumber

            // drop through to continue validation
        } else { // not file:
            // Validate the authority
            if (!isValidAuthority(authority)) {  //otherwise check authority, compulsory
                return false;
            }
        }
